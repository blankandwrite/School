package aqtc.gl.school.widget.flowlayout.wrapper;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAutoSelectEffect = ta.getBoolean(R.styleable.TagFlowLayout_auto_select_effect, false);
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP && mOnTagClickListener != null) {
