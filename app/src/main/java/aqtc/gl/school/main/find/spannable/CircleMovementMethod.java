...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = SchoolApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = SchoolApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
